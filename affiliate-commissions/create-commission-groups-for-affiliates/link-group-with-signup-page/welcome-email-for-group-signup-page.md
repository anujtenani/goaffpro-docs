...
# Set Welcome Email for Group Signup Page

**GoAffPro** provides you with the option to set up a welcome email for the group signup page

To set up a welcome email for the group commission group, go to the **Signup page** section in the **Look and Feel** tab of the GoAffPro admin panel.

<figure><img src="../../../.gitbook/assets/image (189) (1).png" alt=""><figcaption><p>Look and Feel > Signup Page</p></figcaption></figure>
