...
**GoAffPro** provides you with the option to edit texts in the affiliate dashboard.
...
Here, you can search for the text you want to edit and change it.

![Search for the text and edit it](<../../.gitbook/assets/Annotation 2020-05-12 012807.png>)
...
Now, copy-paste the text that you want to change into the search for text field.&#x20;
