...
{% hint style="info" %}
Affiliates can fill out profile fields in their dashboard. You can add additional profile fields, allowing affiliates to include more information in their accounts.
{% endhint %}
...
You also have the "**Disable affiliate's dashboard access until profile is completed**" option, which restricts access for affiliates until they fill out the required profile fields.

<figure><img src="../../../.gitbook/assets/Screenshot 2025-06-04 004432.png" alt=""><figcaption><p>Disable affiliate's dashboard access until profile is completed</p></figcaption></figure>
...
{% embed url="https://youtu.be/0psFay4h9Uo" %}
Additional Profile Fields for Affiliates
{% endembed %}
