# Send Legal Document to Affiliate

**GoAffPro** provides you with the option to send legal documents to affiliates.
...
![Affiliate Profile](<../../../.gitbook/assets/image (2953).png>)

Now, click on **Send Legal Document**.

{% hint style="info" %}
This will depend upon the title of the legal document that you have set.&#x20;
{% endhint %}

![Click on Send Legal Document](<../../../.gitbook/assets/Annotation 2020-03-10 234922.png>)
...
{% embed url="https://youtu.be/PRWTCXRaRYc" %}
Send Legal Document to Affiliate
{% endembed %}
