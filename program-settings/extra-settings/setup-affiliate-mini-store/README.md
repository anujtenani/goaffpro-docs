---
description: Setup Affiliate Store
---

# Setup Affiliate Mini Store

**GoAffPro** provides you with the option to set up a mini store in the affiliate dashboard.&#x20;
...
To set up a mini store in the affiliate dashboard, go to the **Extras** section in the **Settings** tab of the GoAffPro admin panel.
