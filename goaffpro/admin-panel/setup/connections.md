...
The **Connections** tab can be used to connect affiliates with customers. Whenever connected customers make a purchase, the affiliate linked to them will receive a commission. This connection is made using the customer's email address.

### **Enable the Connections tab in the admin panel:**
...
<figure><img src="../../../.gitbook/assets/image (257).png" alt=""><figcaption><p>Connections tab</p></figcaption></figure>
